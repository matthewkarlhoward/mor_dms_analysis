...
SR17018_distances = {str(resi): {"pos": str(resi), "SR17018_distance": min_distance}
                    for resi, min_distance in zip(residue_numbers_mor, min_distances)
                    if min_distance < cutoff_distance}

# Save the results to a CSV file
csv_filename = "SR17018_distances_8EFL.csv"
with open(csv_filename, mode='w', newline='') as csv_file:
    fieldnames = ["pos", "SR17018_distance"]
    ...
    # Write the data
    for result in SR17018_distances.values():
